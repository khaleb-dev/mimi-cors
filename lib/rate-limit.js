...
module.exports = function createRateLimitChecker(CORSANYWHERE_RATELIMIT) {
  ...
  var maxRequestsPerPeriod = parseInt(1000);
  var periodInMinutes = parseInt(120);
  ...
  var rateLimitMessage = 'The number of requests is limited to ' + maxRequestsPerPeriod +
    ...
    'Please self-host mimi-cors if you need more quota. ' +
    'See https://github.com/KhalebOBrien/mimi-cors#demo-server';
